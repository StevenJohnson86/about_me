...
if (userName === null) {
  ...
  if (answer1 === 'Y' || answer1 === 'y') {
    ...
    document.write('<p>A1: Oops! I guess I forgot to tell you that I\'ve been to Canada, Japan, S.Korea, Germany, Switzerland, Italy, and France!</p>');
  }
  ...
  if (answer2 === 'Y' || answer2 === 'y') {
    ...
    document.write('<p>A2: Close guess! I was brought up in the Snoqualmie Valley, which is about 1 hour from Seattle.</p>');
  } else {
    alert('Correct! I grew up in the Snoqualmie Valley, which is about 1 hour from Seattle.');
    console.log(answer2 + ' is correct');
    document.write('<p>A2: Correct! I grew up in the Snoqualmie Valley, which is about 1 hour from Seattle.</p>');
  }
  ...
  if (answer3 === 'Y' || answer3 === 'y') {
    ...
    document.write('<p>A3: Nice one! I am currently in the 201 course at the CodeFellows Seattle Campus.</p>');
  } else {
    alert('Nice try. I am currently in the 201 course at the CodeFellows Seattle Campus.');
    console.log(answer3 + ' is wrong.');
    document.write('<p>A3: Nice try. I am currently in the 201 course at the CodeFellows Seattle Campus.</p>');
  }
  ...
  if (answer3 === 'Y' || answer3 === 'y') {
    ...
    document.write('<p>A4: Correct! I love skiing and hope to go again soon!</p>');
  } else {
    alert('Wrong, I went during the last week of December.');
    console.log(answer4 + ' is wrong.');
    document.write('<p>A4: Wrong, I went during the last week of December.</p>');
  }
  ...
  if (answer5 === 'Y' || answer5 === 'y') {
    ...
    document.write('<p>A5: Right! I learned about the time-value of money when I studied Finance at Pacific Lutheran University in Tacoma, WA.</p>');
  } else {
    ...
    document.write('<p>A5: I don\t believe so. If you need convincing, I\'ll borrow money from you anytime! Why else would banks charge interest?</p>');
  }
